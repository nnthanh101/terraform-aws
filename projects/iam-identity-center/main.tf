...
#   source = "github.com/nnthanh101/terraform-aws//modules/iam-identity-center?ref=iam-identity-center/v1.2.1"

module "identity_center" {
  source  = "app.terraform.io/oceansoft/iam-identity-center/aws"
  version = "~> 1.2"
