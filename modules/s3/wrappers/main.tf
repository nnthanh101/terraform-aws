module "wrapper" {
  ...
  access_log_delivery_policy_source_organizations = try(each.value.access_log_delivery_policy_source_organizations, var.defaults.access_log_delivery_policy_source_organizations, [])
